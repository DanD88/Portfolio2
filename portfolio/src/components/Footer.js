      ...
      <div>
        ...
        <footer className="p-4 bg-gray-800 rounded-lg shadow md:px-6 md:py-8">
          <div className="sm:flex sm:items-center sm:justify-between">
            ...
            <ul className="flex flex-wrap items-center mb-6 text-sm text-gray-500 sm:mb-0 dark:text">
              <li>
          ...
          <span className="block text-sm text-gray-500 sm:text-center dark:text-gray-400 mb-2">Daniel Davidson &copy; 2022</span>
